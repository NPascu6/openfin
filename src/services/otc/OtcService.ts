...
export class OtcService extends HubService {
    ...
    private _lastQuoteRequest: OtcQuoteRequest | undefined = undefined;
    private recentOtcTrades: OtcOrderEntry[] | undefined = undefined;
    ...
    private _fundId: string | undefined = undefined;
    private _currentOtcQuoteId: string | undefined = undefined;
        ...
        try {
            if (this.isDisconnected) {
                ...
                this.hubConnection.onreconnected(connectionId => {
                    ...
                    if (this._accountId && this._lastQuoteRequest && this._lastQuoteRequest !== null && this._accountId !== '') {
    ...
    public async requestQuote(quoteRequest: OtcQuoteRequest): Promise<string | undefined> {
        if (this.isDisconnected) {
            await this.start();
        }
